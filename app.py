...
# Modo Administrador com Senha
    ...
    if st.session_state.admin_authenticated:
        ...
        nova_resposta = st.text("Digite a resposta correspondente:", height=200)  # Caixa de texto para resposta
        ...
        if pergunta_selecionada:
            ...
            resposta_editada = st.text("Editar Resposta:", df.at[indice, "Resposta"], height=200)  # Caixa de texto para resposta
