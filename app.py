...
def encontrar_resposta_por_palavras_chave(prompt, df):
    ...
    return melhor_resposta if melhor_resposta else "Desculpe, não poder te ajudar agora, pergunte ao seu líder e quem sabe na próxima eu ja poderei te ajudar."
