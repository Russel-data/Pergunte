...
def save_data(df):
    try:
        ...
        st.cache_data.clear()  # Limpa o cache para garantir atualização dos dados
    except Exception as e:
...
# Carregar os dados no session_state para evitar perda
...
if modo == "Colaborador":
    ...
    if st.session_state.admin_authenticated:
        ...
        if st.button("Salvar Alterações"):
            ...
            st.session_state.df = df_editado  # Atualiza os dados na sessão
